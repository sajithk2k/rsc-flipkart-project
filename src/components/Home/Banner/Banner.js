...
const Banner = (props) => {
    ...
    return(
        ...
        <div className = {BannerCSS["banner-div"]}>
            <img alt = "Banner Image" className = {BannerCSS["banner-img"]} src ={parseImageUrl(props.widgetData.widget.data.renderableComponents[0].value.aspectRatio,props.widgetData.widget.data.renderableComponents[0].value.dynamicImageUrl)}></img>
        </div>
    );
}
